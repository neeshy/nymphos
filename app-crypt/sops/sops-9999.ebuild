...
if [[ "${PV}" = 9999 ]]; then
	...
	EGO_SUM=(
		...
		"cloud.google.com/go/auth v0.6.0/go.mod"
		...
		"cloud.google.com/go/kms v1.18.0/go.mod"
		...
		"github.com/ProtonMail/go-crypto v1.1.0-alpha.3-proton/go.mod"
		...
		"github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.17.1/go.mod"
		...
		"github.com/aws/aws-sdk-go-v2/internal/v4a v1.3.12/go.mod"
		...
		"github.com/aws/aws-sdk-go-v2/service/internal/checksum v1.3.14/go.mod"
		...
		"github.com/aws/aws-sdk-go-v2/service/internal/s3shared v1.17.12/go.mod"
		"github.com/aws/aws-sdk-go-v2/service/kms v1.34.1"
		"github.com/aws/aws-sdk-go-v2/service/kms v1.34.1/go.mod"
		"github.com/aws/aws-sdk-go-v2/service/s3 v1.56.1"
		"github.com/aws/aws-sdk-go-v2/service/s3 v1.56.1/go.mod"
		...
		"github.com/docker/cli v27.0.1+incompatible/go.mod"
		"github.com/docker/docker v27.0.1+incompatible"
		"github.com/docker/docker v27.0.1+incompatible/go.mod"
		...
		"github.com/hashicorp/go-sockaddr v1.0.6/go.mod"
		...
		"google.golang.org/api v0.186.0/go.mod"
		...
		"google.golang.org/genproto/googleapis/api v0.0.0-20240624140628-dc46fd24d27d/go.mod"
