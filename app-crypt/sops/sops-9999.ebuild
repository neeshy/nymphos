...
if [[ "${PV}" = 9999 ]]; then
	...
	EGO_SUM=(
		...
		"cloud.google.com/go/kms v1.20.1/go.mod"
		...
		"github.com/AzureAD/microsoft-authentication-library-for-go v1.3.1/go.mod"
		...
		"github.com/GoogleCloudPlatform/opentelemetry-operations-go/detectors/gcp v1.24.1/go.mod"
		...
		"github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.17.42/go.mod"
		...
		"github.com/aws/aws-sdk-go-v2/service/kms v1.37.7/go.mod"
		"github.com/aws/aws-sdk-go-v2/service/s3 v1.70.0"
		"github.com/aws/aws-sdk-go-v2/service/s3 v1.70.0/go.mod"
		...
		"google.golang.org/grpc/stats/opentelemetry v0.0.0-20240907200651-3ffb98b2c93a/go.mod"
