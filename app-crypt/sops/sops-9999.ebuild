...
if [[ "${PV}" = 9999 ]]; then
	...
	EGO_SUM=(
		...
		"github.com/opencontainers/runc v1.2.3/go.mod"
		...
		"go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.58.0/go.mod"
		...
		"go.opentelemetry.io/otel/sdk/metric v1.33.0/go.mod"
		...
		"google.golang.org/genproto/googleapis/api v0.0.0-20241223144023-3abc09e42ca8/go.mod"
